# Original: mathiasbynens/dotfiles
...
systemsetup -settimezone "Asia/Tokyo" > /dev/null
...
log_done "Update OSX settings: Note that some of these changes require a logout/restart to take effect."
